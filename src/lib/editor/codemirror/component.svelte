<script context="module">
  ...
  if (is_browser) {
    ...
    codemirror_promise.then(mod => {
      ...
      codemirror_js_promise = import("codemirror/mode/javascript/javascript.js")
      console.log(codemirror_js_promise)
      codemirror_js_promise.then(value => {
        console.log(value)
        _js =value
      })
    });
