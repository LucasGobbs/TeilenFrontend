...
<div class="bg-white h-screen overflow-hidden">
  <div class="flex">
    ...
    <!-- Login Form -->
    <div class="container h-screen w-full p-2 pt-10">
      <div class="max-w-sm mx-auto  bg-white px-5 py-10 rounded  tracking-widest">
        <div class="mb-2 ">
          <h1 class="font-bold text-4xl text-gray-800 font-bold">Cadastro</h1>
        </div>
        <div class="mb-8 ">
          <h1 class="font-normal text-lg tracking-normal text-gray-700">
            já tem conta? 
            <a class="text-indigo-500 font-bold" href="login">
              faça login
            </a>
          </h1>
        </div>
